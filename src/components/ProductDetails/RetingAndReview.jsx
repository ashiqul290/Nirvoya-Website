...
export const RetingAndReview = () => {
  return (
    ...
    <div className=" flex gap-18.75 items-center pl-12">
        <div>
    ...
    <h3 className=' pb-5 pl-12 font-medium font-poppins text-[24px] text-[#333333] mt-8.75'>Reviews (4)</h3>
    ...
    <div className="pl-12">
        ...
        <p className=' font-normal font-poppins text-[18px] text-[#383838] mt-6'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
    </div>
    <div className=" mt-7.5">
        <div className=" flex gap-4 items-center">
            <img src={clientImg} alt="img" />
    ...
    <div className="pl-12 pb-15 mt-17.5">
        ...
        <form action="">
            <div className="mt-8">
                ...
                <input type="text" className='w-193.75 border rounded-[5px] mt-4 h-15 border-[#A7A7A7]' />
            </div> 
            <div className="mt-8">
                <label className='text-[#383838] font-medium font-poppins text-[18px] block' htmlFor="">Email *</label>
                <input type="email" className='w-193.75 border rounded-[5px] mt-4 h-15 border-[#A7A7A7]' />
            </div>
            <div className="mt-8">
                <label className='text-[#383838] font-medium font-poppins text-[18px] block' htmlFor="">Review *</label>
                <textarea name="" id="" className='w-193.75 border rounded-[5px] mt-4 h-29.75 border-[#A7A7A7]'></textarea>
            </div>
