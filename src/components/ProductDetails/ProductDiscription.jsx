        ...
        <div className="pl-12">
          ...
          <div className=" flex">
            <ul className="ml-8 w-2/4">
              ...
              <li className="text-[#333333] font-normal font-poppins text-[18px] list-disc mt-1">Gender : Male</li>
            ...
            <ul className="ml-8 w-2/4">
              ...
              <li className="text-[#333333] font-normal font-poppins text-[18px] list-disc mt-1">
